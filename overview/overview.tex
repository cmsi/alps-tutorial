...
\begin{frame}{なぜQLMを考えるのか? / Why quantum lattice models?}
  \begin{columns}[T]
    \begin{column}{.2\textwidth}
...
\begin{frame}{ALPSとは? / What's ALPS?}
...
\begin{frame}{ターゲット・オーディエンス / Target Audience}
  \begin{itemize}
    \setlength{\itemsep}{1em}
  \item 実験家
    \begin{itemize}
