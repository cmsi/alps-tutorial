...
\begin{frame}[t,fragile]
  ...
  \begin{tabular}{|l|l|c|c|c|}
        ...
        \hline
        アプリケーション実習(2) & {\tt 03\_tutorial} & {\footnotesize\color{red} } & {\footnotesize\color{blue} ◎} & {\footnotesize\color{green} ○} \\
        \hline
        アプリケーションのALPS化 & {\tt 06\_alpsize} & {\footnotesize\color{red} } & {\footnotesize\color{blue} } & {\footnotesize\color{green} ◎} \\
        \hline
  \end{tabular}
\end{frame}
