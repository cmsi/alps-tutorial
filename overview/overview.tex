...
\begin{frame}[t,fragile]{ALPS参考資料}
  ...
  \item MateriApps (日/英): {\footnotesize \url{https://ma.issp.u-tokyo.ac.jp/app/213}}
...
\subsection*{\redb\whiteb\greenb}
\begin{frame}[t,fragile]{ALPSチュートリアル}
  \begin{itemize}
    \setlength{\itemsep}{1em}
  \item チュートリアル資料開発
    \begin{itemize}
    \item 藤堂眞治 (東大院理/物性研)
    \end{itemize}
  \item 開発協力者: 本山裕一, 松尾春彦, 五十嵐亮, 諏訪秀麿, 坂下達也
  \item サポート
    \begin{itemize}
...
\frametitle{``Cite-me''ライセンス}
  \begin{itemize}
  \item GNU General Public License 2 (GPLv2) を基本としたライセンス
